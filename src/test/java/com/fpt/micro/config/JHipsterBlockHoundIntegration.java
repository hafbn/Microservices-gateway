...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.fpt.micro.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.fpt.micro.security.DomainUserDetailsService", "createSpringSecurityUser");
