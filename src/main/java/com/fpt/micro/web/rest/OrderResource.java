...
/**
 * REST controller for managing {@link com.fpt.micro.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderResource {
    ...
    public Mono<List<Order>> getAllOrders(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        if (eagerload) {
            return orderRepository.findAllWithEagerRelationships().collectList();
        } else {
    ...
    public Mono<ResponseEntity<Order>> getOrder(@PathVariable Long id) {
        ...
        Mono<Order> order = orderRepository.findOneWithEagerRelationships(id);
